...
input_file = 'rates_data_march.txt'
...
##print("\nInstructions: Enter all configured POS codes including UAUB Outpatient, UAUB Inpatient and ER. Enter '0' to stop adding POS codes.")
##
...
print("\nInstructions: Enter all configured POS codes for UAUB Out-patient? Enter '0' to stop adding POS codes.")
...
print("\nInstructions: Enter all configured POS codes for UAUB In-patient? Enter '0' to stop adding POS codes.")
...
for everyline in filedata:
  if everyline[0] not in ['E','F','O','R'] and everyline[1] in ['56420','00210','10030','10040','29540','29365','29891','33968','36000','37619','43250','20604']:
    ...
    errate = everyline[5]
    print ('er rate is ', errate)
    cutbackind = everyline[7]
    print ('cutback indicator is ',cutbackind)
    ...
    print ('count of pos for op uaub after considering if code has op uaub rates ', c_pos_op_uaub)
    ...
    print ('count of pos for ip uaub after considering if code has ip uaub rates ', c_pos_ip_uaub)

    print ('list of configured pos to be used after considering uaub configuration',c_pos_list)# this now has pos of uaub only if uaub rates are configured. er and cutback are still present by default
    ...
    if errate == '--':
      if cutbackind == '0':#no er nor cutback
        pos_list = [pos for pos in c_pos_list if pos in pos_uaub_input]#removed pos that were configured for er and cutback since code does not have those rates
      ...
      if cutbackind == '0':# er is present but no cutback 
        ...
        pos_list.extend (pos for pos in c_pos_list if pos in pos_uaub_input) # may or may not have added uaub.
      else:
    ...
    print ('inbetween pos ',inbetween_pos)
    ...
    print ('configured specialty ',c_spl)
    ...
    print ('inbetween specialty ', ib_spl)
    ...
    print ('child component ',child_component)
    print ('adult_component ',adult_component)
    print ('nurse_component ',nurse_component)
    print ('uaub_op_component ',uaub_op_component)
    print ('uaub_ip_component ',uaub_ip_component)
    print ('rental_component ',rental_component)
...
with open('rules_count_debug.csv', 'w') as f:
...
print ('Output csv file by name rules_count_debug has been exported successfully')
