...
train = train.drop(['airlocation','runtime','gender','expensive','money_back_guarantee'], axis = 1)
...
train = train.drop(['ratings','relationship','industry_Other','genre_Direct','airtime_Daytime'], axis = 1)
...
test = test.drop(['airlocation','runtime','gender','expensive','money_back_guarantee'], axis = 1)
...
#dropping one dummy variable of each feature to avoid dummy variable trap
test = test.drop(['ratings','relationship','industry_Other','genre_Direct','airtime_Daytime'], axis = 1)
...
result_submission.to_csv('submission9.csv', index = False)#indexes are not copied in the csv
