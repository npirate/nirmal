...
inactivity_check = 180 #in minutes
...
try:
    for i in range(inactivity_check):
        ...
        pyautogui.hotkey('alt','tab') if (win32api.GetTickCount() - win32api.GetLastInputInfo()) / 1000.0 > 960 else print ('Did not switch screens')
